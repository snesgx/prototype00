...
Select get_filefullpath(1,0xCEFEE3C42B6C397F5863D79D6AA2E656);

Select * from fileindex where file_size in (
Select file_size from fileindex where file_size > 160000 group by file_size having count(*) > 1
) order by file_size desc;


select device_id,file_name,parent_id,id from fileindex where id=0xCEFEE3C42B6C397F5863D79D6AA2E656;